...
var Table = (function () {
    ...
    */
    Table.prototype.update = function (rowAttrs, uniqueKey) {
        if (typeof uniqueKey === "undefined") { uniqueKey = this._defaultUniqueKey; }
    ...
    * @returns {boolean}
    */
    Table.prototype.destroy = function (id, uniqueKey) {
        if (typeof uniqueKey === "undefined") { uniqueKey = this._defaultUniqueKey; }
        var criteria = {};
    ...
    * @returns {boolean}
    */
    Table.prototype.destroyWhere = function (criteria) {
