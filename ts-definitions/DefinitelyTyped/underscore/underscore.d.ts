...
declare module Underscore {
    /**
     * underscore.js Underscore.throttle options.
     **/
...
interface UnderscoreStatic {
     ...
     **/
    each<T>(
        list: Underscore.List<T>,
        iterator: Underscore.ListIterator<T, void>,
        context?: any): Underscore.List<T>;
     ...
     **/
    each<T>(
        object: Underscore.Dictionary<T>,
        iterator: Underscore.ObjectIterator<T, void>,
        context?: any): Underscore.Dictionary<T>;
    ...
    map<T, TResult>(
        list: Underscore.List<T>,
        iterator: Underscore.ListIterator<T, TResult>,
        context?: any): TResult[];
    ...
    map<T, TResult>(
        object: Underscore.Dictionary<T>,
        iterator: Underscore.ObjectIterator<T, TResult>,
        context?: any): TResult[];
     ...
     **/
    reduce<T, TResult>(
        list: Underscore.Collection<T>,
        iterator: Underscore.MemoIterator<T, TResult>,
        memo?: TResult,
        context?: any): TResult;
    ...
    find<T>(
        list: Underscore.List<T>,
        iterator: Underscore.ListIterator<T, boolean>,
        context?: any): T;
    ...
    find<T>(
        object: Underscore.Dictionary<T>,
        iterator: Underscore.ObjectIterator<T, boolean>,
        context?: any): T;
     ...
     **/
    max(list: Underscore.List<number>): number;
    ...
    max<T>(
        list: Underscore.List<T>,
        iterator?: Underscore.ListIterator<T, any>,
        context?: any): T;
     ...
     **/
    min(list: Underscore.List<number>): number;
    ...
    sortBy<T, TSort>(
        list: Underscore.List<T>,
        iterator?: Underscore.ListIterator<T, TSort>,
        context?: any): T[];

    /**
     * @see Underscore.sortBy
     * @param iterator Sort iterator for each element within `list`.
     **/
    sortBy<T>(
        list: Underscore.List<T>,
     ...
     * returns an object with an index of each item.  Just like Underscore.groupBy, but for when you know your keys are unique.
     **/
    indexBy<T>(
        list: Underscore.List<T>,
        iterator: Underscore.ListIterator<T, any>,
    ...
    countBy<T>(
        list: Underscore.List<T>,
        iterator?: Underscore.ListIterator<T, any>,
        context?: any): Underscore.Dictionary<number>;

    /**
     * @see Underscore.countBy
     ...
     **/
    shuffle<T>(list: Underscore.Collection<T>): T[];
     ...
     **/
    sample<T>(list: Underscore.Collection<T>, n: number): T[];

    /**
     * @see Underscore.sample
     **/
    sample<T>(list: Underscore.Collection<T>): T;
     ...
     **/
    toArray<T>(list: Underscore.Collection<T>): T[];
     ...
     **/
    size<T>(list: Underscore.Collection<T>): number;
     ...
     **/
    first<T>(array: Underscore.List<T>): T;
     ...
     **/
    first<T>(
        array: Underscore.List<T>,
        n: number): T[];

    /**
     * @see Underscore.first
     **/
    head<T>(array: Underscore.List<T>): T;
     ...
     * @see Underscore.first
     **/
    take<T>(array: Underscore.List<T>): T;
     ...
     **/
    last<T>(array: Underscore.List<T>): T;
     ...
     **/
    compact<T>(array: Underscore.List<T>): T[];
     ...
     **/
    union<T>(...arrays: Underscore.List<T>[]): T[];
     ...
     **/
    intersection<T>(...arrays: Underscore.List<T>[]): T[];
    ...
    object<TResult extends {}>(
        keys: Underscore.List<string>,
        values: Underscore.List<any>): TResult;
    ...
    /**
     * @see Underscore.object
     **/
    object<TResult extends {}>(
        list: Underscore.List<any>,
        values?: any): TResult;
    ...
    throttle(
        func: any,
        wait: number,
        options?: Underscore.ThrottleSettings): Function;
     ...
     **/
    matches<T, TResult>(attrs: T): Underscore.ListIterator<T, TResult>;
    ...
    /**
     * Creates a function that returns the same value that is used as the argument of Underscore.constant
     * @param value Identity of this object.
     ...
     * function. The settings argument should be a hash containing any Underscore.templateSettings that should
     * be overridden.
     ...
     **/
    template(templateString: string, data?: any, settings?: Underscore.TemplateSettings): (...data: any[]) => string;
...
interface Underscore<T> {
     ...
     * @see Underscore.each
     **/
    each(iterator: Underscore.ListIterator<T, void>, context?: any): T[];

    /**
     * @see Underscore.each
     **/
    each(iterator: Underscore.ObjectIterator<T, void>, context?: any): T[];

    /**
     * @see Underscore.each
     **/
    forEach(iterator: Underscore.ListIterator<T, void>, context?: any): T[];

    /**
     * @see Underscore.each
     **/
    forEach(iterator: Underscore.ObjectIterator<T, void>, context?: any): T[];

    /**
     * Wrapped type `any[]`.
     * @see Underscore.map
     **/
    map<TResult>(iterator: Underscore.ListIterator<T, TResult>, context?: any): TResult[];

    /**
     * Wrapped type `any[]`.
     * @see Underscore.map
     **/
    map<TResult>(iterator: Underscore.ObjectIterator<T, TResult>, context?: any): TResult[];

    /**
     * @see Underscore.map
     **/
    collect<TResult>(iterator: Underscore.ListIterator<T, TResult>, context?: any): TResult[];

    /**
     * @see Underscore.map
     **/
    collect<TResult>(iterator: Underscore.ObjectIterator<T, TResult>, context?: any): TResult[];

    /**
     * Wrapped type `any[]`.
     * @see Underscore.reduce
     **/
    reduce<TResult>(iterator: Underscore.MemoIterator<T, TResult>, memo?: TResult, context?: any): TResult;

    /**
     * @see Underscore.reduce
     **/
    inject<TResult>(iterator: Underscore.MemoIterator<T, TResult>, memo?: TResult, context?: any): TResult;

    /**
     * @see Underscore.reduce
     **/
    foldl<TResult>(iterator: Underscore.MemoIterator<T, TResult>, memo?: TResult, context?: any): TResult;

    /**
     * Wrapped type `any[]`.
     * @see Underscore.reduceRight
     **/
    reduceRight<TResult>(iterator: Underscore.MemoIterator<T, TResult>, memo?: TResult, context?: any): TResult;

    /**
     * @see Underscore.reduceRight
     **/
    foldr<TResult>(iterator: Underscore.MemoIterator<T, TResult>, memo?: TResult, context?: any): TResult;

    /**
     * Wrapped type `any[]`.
     * @see Underscore.find
     **/
    find(iterator: Underscore.ListIterator<T, boolean>, context?: any): T;

    /**
     * @see Underscore.find
     **/
    detect(iterator: Underscore.ListIterator<T, boolean>, context?: any): T;

    /**
     * Wrapped type `any[]`.
     * @see Underscore.filter
     **/
    filter(iterator: Underscore.ListIterator<T, boolean>, context?: any): T[];

    /**
     * @see Underscore.filter
     **/
    select(iterator: Underscore.ListIterator<T, boolean>, context?: any): T[];

    /**
     * Wrapped type `any[]`.
     * @see Underscore.where
     **/
    where<U extends {}>(properties: U): T[];

    /**
     * Wrapped type `any[]`.
     * @see Underscore.findWhere
     **/
     ...
     * @see Underscore.reject
     **/
    reject(iterator: Underscore.ListIterator<T, boolean>, context?: any): T[];

    /**
     * Wrapped type `any[]`.
     * @see Underscore.all
     **/
    all(iterator?: Underscore.ListIterator<T, boolean>, context?: any): boolean;

    /**
     * @see Underscore.all
     **/
    every(iterator?: Underscore.ListIterator<T, boolean>, context?: any): boolean;

    /**
     * Wrapped type `any[]`.
     * @see Underscore.any
     **/
    any(iterator?: Underscore.ListIterator<T, boolean>, context?: any): boolean;

    /**
     * @see Underscore.any
     **/
    some(iterator?: Underscore.ListIterator<T, boolean>, context?: any): boolean;
     ...
     * @see Underscore.max
     **/
    max(iterator: Underscore.ListIterator<T, number>, context?: any): T;

    /**
     * Wrapped type `any[]`.
     * @see Underscore.max
     **/
    max(iterator?: Underscore.ListIterator<T, any>, context?: any): T;
     ...
     * @see Underscore.min
     **/
    min(iterator: Underscore.ListIterator<T, number>, context?: any): T;

    /**
     * Wrapped type `any[]`.
     * @see Underscore.min
     **/
    min(iterator?: Underscore.ListIterator<T, any>, context?: any): T;

    /**
     * Wrapped type `any[]`.
     * @see Underscore.sortBy
     **/
    sortBy(iterator?: Underscore.ListIterator<T, any>, context?: any): T[];
     ...
     * @see Underscore.groupBy
     **/
    groupBy(iterator?: Underscore.ListIterator<T, any>, context?: any): Underscore.Dictionary<Underscore.List<T>>;

    /**
     * Wrapped type `any[]`.
     * @see Underscore.groupBy
     **/
    groupBy(iterator: string, context?: any): Underscore.Dictionary<T[]>;

    /**
     * Wrapped type `any[]`.
     * @see Underscore.indexBy
     **/
    indexBy(iterator: Underscore.ListIterator<T, any>, context?: any): Underscore.Dictionary<T>;

    /**
     * Wrapped type `any[]`.
     * @see Underscore.indexBy
     **/
    indexBy(iterator: string, context?: any): Underscore.Dictionary<T>;

    /**
     * Wrapped type `any[]`.
     * @see Underscore.countBy
     **/
    countBy(iterator?: Underscore.ListIterator<T, any>, context?: any): Underscore.Dictionary<number>;

    /**
     * Wrapped type `any[]`.
     * @see Underscore.countBy
     **/
    countBy(iterator: string, context?: any): Underscore.Dictionary<number>;

    /**
     * Wrapped type `any[]`.
     * @see Underscore.shuffle
     **/
    shuffle(): T[];
    ...
    /**
     * Wrapped type `any[]`.
     * @see Underscore.compact
     **/
    compact(): T[];

    /**
     * Wrapped type `any`.
     * @see Underscore.flatten
     **/
    flatten(shallow?: boolean): any[];

    /**
     * Wrapped type `any[]`.
     * @see Underscore.without
     **/
    without(...values: T[]): T[];

    /**
     * Wrapped type `any[]`.
     * @see Underscore.partition
     **/
    partition(iterator: Underscore.ListIterator<T, boolean>, context?: any): T[][];

    /**
     * Wrapped type `any[][]`.
     * @see Underscore.union
     **/
    union(...arrays: Underscore.List<T>[]): T[];

    /**
     * Wrapped type `any[][]`.
     * @see Underscore.intersection
     **/
    intersection(...arrays: Underscore.List<T>[]): T[];

    /**
     * Wrapped type `any[]`.
     * @see Underscore.difference
     **/
    difference(...others: Underscore.List<T>[]): T[];

    /**
     * Wrapped type `any[]`.
     * @see Underscore.uniq
     **/
    uniq(isSorted?: boolean, iterator?: Underscore.ListIterator<T, any>): T[];

    /**
     * Wrapped type `any[]`.
     * @see Underscore.uniq
     **/
    uniq<TSort>(iterator?: Underscore.ListIterator<T, TSort>, context?: any): T[];

    /**
     * @see Underscore.uniq
     **/
    unique<TSort>(isSorted?: boolean, iterator?: Underscore.ListIterator<T, TSort>): T[];

    /**
     * @see Underscore.uniq
     **/
    unique<TSort>(iterator?: Underscore.ListIterator<T, TSort>, context?: any): T[];
    ...
    /**
     * Wrapped type `any[]`.
     * @see Underscore.lastIndexOf
     **/
    lastIndexOf(value: T, from?: number): number;

    /**
     * Wrapped type `any[]`.
     * @see Underscore.sortedIndex
     **/
    ...
    /**
     * Wrapped type `Function`.
     * @see Underscore.throttle
     **/
    throttle(wait: number, options?: Underscore.ThrottleSettings): Function;

    /**
     * Wrapped type `Function`.
     * @see Underscore.debounce
     **/
    ...
    /**
     * Wrapped type `object`.
     * @see Underscore.values
     **/
    values(): T[];

    /**
     * Wrapped type `object`.
     * @see Underscore.pairs
     **/
    pairs(): any[][];

    /**
     * Wrapped type `object`.
     * @see Underscore.invert
     **/
    invert(): any;
    ...
    /**
     * Wrapped type `any[]`.
     * @see Underscore.matches
     **/
    matches<TResult>(): Underscore.ListIterator<T, TResult>;

    /**
     * Wrapped type `string`.
     * @see Underscore.property
     **/
    property(): (object: Object) => any;

    /**
     * Wrapped type `object`.
     * @see Underscore.isEqual
     **/
    isEqual(other: any): boolean;

    /**
     * Wrapped type `object`.
     * @see Underscore.isEmpty
     **/
    isEmpty(): boolean;

    /**
     * Wrapped type `object`.
     * @see Underscore.isElement
     **/
    isElement(): boolean;

    /**
     * Wrapped type `object`.
     * @see Underscore.isArray
     **/
    isArray(): boolean;

    /**
     * Wrapped type `object`.
     * @see Underscore.isObject
     **/
    isObject(): boolean;

    /**
     * Wrapped type `object`.
     * @see Underscore.isArguments
     **/
    isArguments(): boolean;
    ...
    /**
     * Wrapped type `object`.
     * @see Underscore.isDate
     **/
    isDate(): boolean;

    /**
     * Wrapped type `object`.
     * @see Underscore.isRegExp
     **/
    isRegExp(): boolean;

    /**
     * Wrapped type `object`.
     * @see Underscore.isNaN
     **/
    isNaN(): boolean;

    /**
     * Wrapped type `object`.
     * @see Underscore.isNull
     **/
    isNull(): boolean;

    /**
     * Wrapped type `object`.
     * @see Underscore.isUndefined
     **/
    isUndefined(): boolean;
    ...
    /**
     * Wrapped type `any`.
     * @see Underscore.identity
     **/
    identity(): any;

    /**
     * Wrapped type `any`.
     * @see Underscore.constant
     **/
    constant(): () => T;

    /**
     * Wrapped type `number`.
     * @see Underscore.times
     **/
    ...
    /**
     * Wrapped type `string`.
     * @see Underscore.escape
     **/
    escape(): string;

    /**
     * Wrapped type `string`.
     * @see Underscore.unescape
     **/
    unescape(): string;
    ...
    /**
     * Wrapped type `string`.
     * @see Underscore.template
     **/
    template(data?: any, settings?: Underscore.TemplateSettings): (...data: any[]) => string;
    ...
    /**
     * Wrapped type `any`.
     * @see Underscore.chain
     **/
    chain(): _Chain<T>;

    /**
     * Wrapped type `any`.
     * @see Underscore.value
     **/
...
interface _Chain<T> {
     ...
     * @see Underscore.each
     **/
    each(iterator: Underscore.ListIterator<T, void>, context?: any): _Chain<T>;

    /**
     * @see Underscore.each
     **/
    each(iterator: Underscore.ObjectIterator<T, void>, context?: any): _Chain<T>;

    /**
     * @see Underscore.each
     **/
    forEach(iterator: Underscore.ListIterator<T, void>, context?: any): _Chain<T>;

    /**
     * @see Underscore.each
     **/
    forEach(iterator: Underscore.ObjectIterator<T, void>, context?: any): _Chain<T>;

    /**
     * Wrapped type `any[]`.
     * @see Underscore.map
     **/
    map<TArray>(iterator: Underscore.ListIterator<T, TArray[]>, context?: any): _ChainOfArrays<TArray>;

    /**
     * Wrapped type `any[]`.
     * @see Underscore.map
     **/
    map<TResult>(iterator: Underscore.ListIterator<T, TResult>, context?: any): _Chain<TResult>;

    /**
     * Wrapped type `any[]`.
     * @see Underscore.map
     **/
    map<TArray>(iterator: Underscore.ObjectIterator<T, TArray[]>, context?: any): _ChainOfArrays<TArray>;

    /**
     * Wrapped type `any[]`.
     * @see Underscore.map
     **/
    map<TResult>(iterator: Underscore.ObjectIterator<T, TResult>, context?: any): _Chain<TResult>;

    /**
     * @see Underscore.map
     **/
    collect<TResult>(iterator: Underscore.ListIterator<T, TResult>, context?: any): _Chain<T>;

    /**
     * @see Underscore.map
     **/
    collect<TResult>(iterator: Underscore.ObjectIterator<T, TResult>, context?: any): _Chain<T>;

    /**
     * Wrapped type `any[]`.
     * @see Underscore.reduce
     **/
    reduce<TResult>(iterator: Underscore.MemoIterator<T, TResult>, memo?: TResult, context?: any): _Chain<T>;

    /**
     * @see Underscore.reduce
     **/
    inject<TResult>(iterator: Underscore.MemoIterator<T, TResult>, memo?: TResult, context?: any): _Chain<T>;

    /**
     * @see Underscore.reduce
     **/
    foldl<TResult>(iterator: Underscore.MemoIterator<T, TResult>, memo?: TResult, context?: any): _Chain<T>;

    /**
     * Wrapped type `any[]`.
     * @see Underscore.reduceRight
     **/
    reduceRight<TResult>(iterator: Underscore.MemoIterator<T, TResult>, memo?: TResult, context?: any): _Chain<T>;

    /**
     * @see Underscore.reduceRight
     **/
    foldr<TResult>(iterator: Underscore.MemoIterator<T, TResult>, memo?: TResult, context?: any): _Chain<T>;

    /**
     * Wrapped type `any[]`.
     * @see Underscore.find
     **/
    find(iterator: Underscore.ListIterator<T, boolean>, context?: any): _ChainSingle<T>;

    /**
     * @see Underscore.find
     **/
    detect(iterator: Underscore.ListIterator<T, boolean>, context?: any): _Chain<T>;

    /**
     * Wrapped type `any[]`.
     * @see Underscore.filter
     **/
    filter(iterator: Underscore.ListIterator<T, boolean>, context?: any): _Chain<T>;

    /**
     * @see Underscore.filter
     **/
    select(iterator: Underscore.ListIterator<T, boolean>, context?: any): _Chain<T>;
     ...
     * @see Underscore.reject
     **/
    reject(iterator: Underscore.ListIterator<T, boolean>, context?: any): _Chain<T>;

    /**
     * Wrapped type `any[]`.
     * @see Underscore.all
     **/
    all(iterator?: Underscore.ListIterator<T, boolean>, context?: any): _Chain<T>;

    /**
     * @see Underscore.all
     **/
    every(iterator?: Underscore.ListIterator<T, boolean>, context?: any): _Chain<T>;

    /**
     * Wrapped type `any[]`.
     * @see Underscore.any
     **/
    any(iterator?: Underscore.ListIterator<T, boolean>, context?: any): _Chain<T>;

    /**
     * @see Underscore.any
     **/
    some(iterator?: Underscore.ListIterator<T, boolean>, context?: any): _Chain<T>;
     ...
     * @see Underscore.max
     **/
    max(iterator: Underscore.ListIterator<T, number>, context?: any): _ChainSingle<T>;

    /**
     * Wrapped type `any[]`.
     * @see Underscore.max
     **/
    max(iterator?: Underscore.ListIterator<T, any>, context?: any): _ChainSingle<T>;
     ...
     * @see Underscore.min
     **/
    min(iterator: Underscore.ListIterator<T, number>, context?: any): _ChainSingle<T>;

    /**
     * Wrapped type `any[]`.
     * @see Underscore.min
     **/
    min(iterator?: Underscore.ListIterator<T, any>, context?: any): _ChainSingle<T>;

    /**
     * Wrapped type `any[]`.
     * @see Underscore.sortBy
     **/
    sortBy(iterator?: Underscore.ListIterator<T, any>, context?: any): _Chain<T>;
     ...
     * @see Underscore.groupBy
     **/
    groupBy(iterator?: Underscore.ListIterator<T, any>, context?: any): _Chain<T>;
     ...
     * @see Underscore.indexBy
     **/
    indexBy(iterator: Underscore.ListIterator<T, any>, context?: any): _Chain<T>;
     ...
     * @see Underscore.countBy
     **/
    countBy(iterator?: Underscore.ListIterator<T, any>, context?: any): _Chain<T>;
     ...
     * @see Underscore.partition
     **/
    partition(iterator: Underscore.ListIterator<T, boolean>, context?: any): _Chain<T[][]>;

    /**
     * Wrapped type `any[][]`.
     * @see Underscore.union
     **/
    union(...arrays: Underscore.List<T>[]): _Chain<T>;

    /**
     * Wrapped type `any[][]`.
     * @see Underscore.intersection
     **/
    intersection(...arrays: Underscore.List<T>[]): _Chain<T>;

    /**
     * Wrapped type `any[]`.
     * @see Underscore.difference
     **/
    difference(...others: Underscore.List<T>[]): _Chain<T>;

    /**
     * Wrapped type `any[]`.
     * @see Underscore.uniq
     **/
    uniq(isSorted?: boolean, iterator?: Underscore.ListIterator<T, any>): _Chain<T>;

    /**
     * Wrapped type `any[]`.
     * @see Underscore.uniq
     **/
    uniq<TSort>(iterator?: Underscore.ListIterator<T, TSort>, context?: any): _Chain<T>;

    /**
     * @see Underscore.uniq
     **/
    unique<TSort>(isSorted?: boolean, iterator?: Underscore.ListIterator<T, TSort>): _Chain<T>;

    /**
     * @see Underscore.uniq
     **/
    unique<TSort>(iterator?: Underscore.ListIterator<T, TSort>, context?: any): _Chain<T>;
     ...
     * @see Underscore.throttle
     **/
    throttle(wait: number, options?: Underscore.ThrottleSettings): _Chain<T>;
     ...
     * @see Underscore.template
     **/
    template(data?: any, settings?: Underscore.TemplateSettings): (...data: any[]) => _Chain<T>;
